...
export async function getGenCodeList(params?: GenCodeTableListParams) {
  ...
  return request(`/admin/tool/gen/list?${queryString}`, {
    data: params,
    method: 'get',
    headers: {
...
export async function getGenCode(id?: string) {
  return request(`/admin/tool/gen/${id}`, {
    method: 'get',
    headers: {
      'Content-Type': 'application/json;charset=UTF-8',
    },
...
export async function queryTableList(params?: any) {
  const queryString = new URLSearchParams(params).toString();
  return request(`/admin/tool/gen/db/list?${queryString}`, {
    data: params,
    method: 'get',
    headers: {
      'Content-Type': 'application/json;charset=UTF-8',
...
export async function importTables(tables?: string) {
  return request(`/admin/tool/gen/importTable?tables=${tables}`, {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json;charset=UTF-8',
    },
...
export async function removeData(params: { ids: string[] }) {
  return request(`/admin/tool/gen/${params.ids}`, {
    method: 'delete',
    headers: {
      'Content-Type': 'application/json;charset=UTF-8',
    },
...
export async function syncDbInfo(tableName: string) {
  return request(`/admin/tool/gen/synchDb/${tableName}`, {
    method: 'GET',
  });
}
...
export async function genCode(tableName: string) {
  return request(`/admin/tool/gen/genCode/${tableName}`, {
    method: 'GET',
  });
}
...
export async function batchGenCode(tableName: string) {
  return downLoadZip(`/admin/tool/gen/batchGenCode?tables=${tableName}`);
}

// 预览
export async function previewCode(id: string) {
  return request(`/admin/tool/gen/preview/${id}`, {
    method: 'GET',
    headers: {
      'Content-Type': 'application/json;charset=UTF-8',
    },
