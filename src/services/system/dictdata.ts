...
export async function getDictDataList(
  ...
  return request<API.System.DictDataPageResult>('/admin/system/dict/data/list', {
    method: 'GET',
    headers: {
...
export function getDictData(dictCode: number, options?: { [key: string]: any }) {
  return request<API.System.DictDataInfoResult>(`/admin/system/dict/data/${dictCode}`, {
    method: 'GET',
    ...(options || {}),
  });
}
...
export async function addDictData(params: API.System.DictData, options?: { [key: string]: any }) {
  return request<API.Result>('/admin/system/dict/data', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json;charset=UTF-8',
    },
...
export async function removeDictData(ids: string, options?: { [key: string]: any }) {
  return request<API.Result>(`/admin/system/dict/data/${ids}`, {
    method: 'DELETE',
    ...(options || {}),
  });
}
...
export function exportDictData(
  ...
  return downLoadXlsx(`/admin/system/dict/data/export`, { params }, `dict_data_${new Date().getTime()}.xlsx`);
}
