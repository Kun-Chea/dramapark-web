...
export async function getRoleList(params?: API.System.RoleListParams) {
  return request<API.System.RolePageResult>('/admin/system/role/list', {
    method: 'GET',
...
export function getRole(roleId: number) {
  return request<API.System.RoleInfoResult>(`/admin/system/role/${roleId}`, {
    method: 'GET'
  });
}
...
export async function addRole(params: API.System.Role) {
  return request<API.Result>('/admin/system/role', {
    method: 'POST',
    headers: {
...
export async function removeRole(ids: string) {
  return request<API.Result>(`/admin/system/role/${ids}`, {
    method: 'DELETE'
  });
}
...
export function exportRole(params?: API.System.RoleListParams) {
  return downLoadXlsx(`/admin/system/role/export`, { params }, `role_${new Date().getTime()}.xlsx`);
}

// 获取角色菜单列表
export function getRoleMenuList(id: number) {
  return request<API.System.RoleMenuResult>(`/admin/system/menu/roleMenuTreeselect/${id}`, {
    method: 'get',
  });
}
...
export function updateRoleDataScope(data: Record<string, any>) {
  return request('/admin/system/role/dataScope', {
    method: 'put',
    data
  })
}
...
export function changeRoleStatus(roleId: number, status: string) {
  ...
  return request<API.Result>('/admin/system/role/changeStatus', {
    method: 'put',
    data: data
  })
}
...
export function allocatedUserList(params?: API.System.RoleListParams) {
  return request('/admin/system/role/authUser/allocatedList', {
    method: 'get',
    params
  })
}
...
export function unallocatedUserList(params?: API.System.RoleListParams) {
  return request('/admin/system/role/authUser/unallocatedList', {
    method: 'get',
    params
  })
}
...
export function authUserCancel(data: any) {
  return request<API.Result>('/admin/system/role/authUser/cancel', {
    method: 'put',
    data: data
  })
}
...
export function authUserCancelAll(data: any) {
  return request<API.Result>('/admin/system/role/authUser/cancelAll', {
    method: 'put',
    params: data
  })
}
...
export function authUserSelectAll(data: Record<string, any>) {
  return request<API.Result>('/admin/system/role/authUser/selectAll', {
    method: 'put',
    params: data,
    headers: { 'Content-Type': ContentType.FORM_URLENCODED },
  })
...
export function getDeptTreeSelect(roleId: number) {
  return request('/admin/system/role/deptTree/' + roleId, {
    method: 'get'
  })
}
