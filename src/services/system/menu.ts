...
export async function getMenuList(params?: API.System.MenuListParams, options?: { [key: string]: any }) {
  return request<API.System.MenuPageResult>('/admin/system/menu/list', {
    method: 'GET',
    headers: {
...
export function getMenu(menuId: number, options?: { [key: string]: any }) {
  return request<API.System.MenuInfoResult>(`/admin/system/menu/${menuId}`, {
    method: 'GET',
    ...(options || {})
  });
}
...
export async function addMenu(params: API.System.Menu, options?: { [key: string]: any }) {
  return request<API.Result>('/admin/system/menu', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json;charset=UTF-8',
    },
...
export async function removeMenu(ids: string, options?: { [key: string]: any }) {
  return request<API.Result>(`/admin/system/menu/${ids}`, {
    method: 'DELETE',
    ...(options || {})
  });
}
...
export function getMenuTree() {
  return request('/admin/system/menu/treeselect', {
    method: 'GET',
  });
}
