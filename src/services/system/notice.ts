...
export async function getNoticeList(params?: API.System.NoticeListParams) {
  return request<API.System.NoticePageResult>('/admin/system/notice/list', {
    method: 'GET',
    headers: {
...
export function getNotice(noticeId: number) {
  return request<API.System.NoticeInfoResult>(`/admin/system/notice/${noticeId}`, {
    method: 'GET'
  });
}
...
export async function addNotice(params: API.System.Notice) {
  return request<API.Result>('/admin/system/notice', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json;charset=UTF-8',
    },
...
export async function removeNotice(ids: string) {
  return request<API.Result>(`/admin/system/notice/${ids}`, {
    method: 'DELETE'
  });
}
